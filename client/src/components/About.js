...
//                 {/* --- Skills & Education Sections (remain centered) --- */}
//                 <div className="text-center">
//                     <motion.h3 className="text-3xl font-bold mb-8" /* ...animation props... */>
//                         Skills & <span className="text-accent">Experience</span>
//                     </motion.h3>
//                     <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 max-w-4xl mx-auto mb-16">
//                         {skills.map((skill, index) => (
//                             <motion.div
//                                 key={skill.name}
//                                 className="flex flex-col items-center justify-center p-4 bg-slate-800 rounded-lg shadow-lg shadow-accent/20 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:shadow-accent/40"
//                             // ...animation props
//                             >
...
//                             <motion.div
//                                 key={edu.institution}
//                                 className="bg-slate-800 p-6 rounded-lg shadow-lg shadow-accent/20 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:shadow-accent/40 flex items-start space-x-4"
//                             // ...animation props
//                             >
...
// Data for your skills, with C++ moved after JavaScript
const skills = [
    { name: 'HTML5', icon: <FaHtml5 size={50} />, color: 'text-orange-500' },
    { name: 'CSS3', icon: <FaCss3Alt size={50} />, color: 'text-blue-500' },
    { name: 'JavaScript', icon: <FaJsSquare size={50} />, color: 'text-yellow-400' },
    { name: 'C++', icon: <SiCplusplus size={50} />, color: 'text-blue-600' }, // Moved here
    { name: 'React', icon: <FaReact size={50} />, color: 'text-cyan-400' },
    { name: 'Tailwind CSS', icon: <SiTailwindcss size={50} />, color: 'text-teal-400' },
    { name: 'MongoDB', icon: <SiMongodb size={50} />, color: 'text-green-400' },
    { name: 'Leadership', icon: <FaUsers size={50} />, color: 'text-accent' },
